...
const ChartContainer = () => (
  <>
    <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '10px' }}>
      ...
      <div style={{ flex: '1', minWidth: '200px', maxWidth: '59%', backgroundColor: '#F0F7FD', border: '1px solid #ECEEF6', borderRadius: 6.27, boxShadow: '0 2px 24px rgba(101, 101, 101, 0.1)', padding: '10px 20px' }}>
